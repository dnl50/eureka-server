...
@TestPropertySource("classpath:application-allow-all.properties")
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
class AllowAllSecurityConfigurationTest {
    ...
    @Test
    void getReturnsOkWithoutAuthentication() throws Exception {
        // given / when / then
